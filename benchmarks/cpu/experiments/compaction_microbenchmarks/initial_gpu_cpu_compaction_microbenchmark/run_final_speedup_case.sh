...
GPU_DEFAULTS_FILE="${REPO_ROOT}/cuda_test_shafin/final_speedup_gpu_defaults.sh"
...
FINAL_VALUE_SIZES="${FINAL_VALUE_SIZES:-${FINAL_SPEEDUP_GPU_DEFAULT_VALUE_SIZES}}"
FINAL_SUBCOMP_THREADS_LIST="${FINAL_SUBCOMP_THREADS_LIST:-1 2 4 8 16 32}"
FINAL_GPU_MODES="${FINAL_GPU_MODES:-${FINAL_SPEEDUP_GPU_DEFAULT_MODES}}"
FINAL_GPU_RUNS="${FINAL_GPU_RUNS:-${FINAL_SPEEDUP_GPU_DEFAULT_RUNS}}"
...
FINAL_GPU_USER_KEY_SPACE="${FINAL_GPU_USER_KEY_SPACE:-${FINAL_SPEEDUP_GPU_DEFAULT_USER_KEY_SPACE}}"
FINAL_GPU_ZIPF_ALPHA="${FINAL_GPU_ZIPF_ALPHA:-${FINAL_SPEEDUP_GPU_DEFAULT_ZIPF_ALPHA}}"

FINAL_CPU_RUN_QUIET="${FINAL_CPU_RUN_QUIET:-1}"
FINAL_RUN_PAUSE_SECONDS="${FINAL_RUN_PAUSE_SECONDS:-2}"
FINAL_GRAPH_DIR="${FINAL_GRAPH_DIR:-${FINAL_SPEEDUP_GPU_DEFAULT_GRAPH_DIR}}"
