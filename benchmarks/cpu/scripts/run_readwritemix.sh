...
for value_size in ${VALUE_SIZES}; do
  ...
  for comp_threads in ${COMP_THREADS_LIST}; do
    ...
    for write_ratio in ${WRITE_RATIOS}; do
      ...
      DB_DIR="${DB_BASE_DIR}/readwritemix/value_${value_size}/comp_${comp_threads}/write_${write_ratio}"
      WAL_DIR="${WAL_BASE_DIR}/readwritemix/value_${value_size}/comp_${comp_threads}/write_${write_ratio}"
