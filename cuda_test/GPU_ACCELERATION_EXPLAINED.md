...
| **3 — Total** | Combined compaction time: 7 different CPU/GPU path combinations |
| **4 — fillrandom** | Projects single-round timings across N compaction rounds to simulate a `db_bench fillrandom` workload |
